...
export class HomePage {
  ...
  selectedEvent: any;
  isSelected: any;
  constructor(private alertCtrl: AlertController, public navCtrl: NavController,  private calendar: Calendar) {}
...
/**Creating the functions for push calender date items to  the arrays that will be displaying the full calendar date. */
...
/**Function for next month button action */
goToNextMonth(){
